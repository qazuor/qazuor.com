...
function IconComponent({ size, ...props }: SunMediumProps) {
    ...
    return (
        <motion.svg
            ...
            {...props}
        >
            <motion.circle cx="12" cy="12" r="4" variants={variants.circle} initial="initial" animate={controls} />
            <motion.line x1="12" y1="4" x2="12" y2="3" variants={variants.line1} initial="initial" animate={controls} />
            <motion.line
                x1="17.7"
                y1="6.3"
                x2="18.4"
            ...
            <motion.line
                ...
                animate={controls}
            />
            <motion.line x1="4" y1="12" x2="3" y2="12" variants={variants.line7} initial="initial" animate={controls} />
            <motion.line
                x1="6.3"
                y1="6.3"
                x2="5.6"
