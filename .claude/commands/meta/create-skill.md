...
category: system
description:
  Interactive wizard to create a new skill for specialized, reusable workflows
...
Guides you through creating a new skill for the Hospeda project. Skills are
specialized, reusable workflows that can be invoked by agents during task
execution. This wizard ensures skills follow project standards, integrate
properly with agents, and provide clear, actionable workflows.
...
- `--category <category>`: Skill category (testing, development, validation,
  documentation)
...
1. **Skill Name** (kebab-case):
   - Examples: `api-integration-testing`, `git-workflow-helper`,
...
**Purpose**: {What this skill does} **Category**: {category} **Primary Users**:
...
**Context**: {situation} **Invocation**: {how skill is called} **Process**:
{what happens} **Result**: {outcome}

## Error Handling

### Error: {Error Type}

**Cause**: {why it happens} **Resolution**: {how to fix}
...
**Purpose**: {what-skill-does} **Category**: {category} **Primary Users**:
{agents}
...
**Context**: {context} **Process**: {process} **Result**: {result}
...
**Purpose**: {validation-purpose} **Category**: validation **Primary Users**:
{agents}
...
**Purpose**: {purpose} **Category**: {category} **Primary Users**: {agents}
...
- **Valid Categories**: testing, development, validation, documentation,
  automation, analysis
...
This command streamlines skill creation while ensuring reusability, clarity, and
