...
**Purpose**: Streamlined workflow for trivial changes that require minimal
overhead

**Scope**: < 30 minutes, 1-2 files, very low risk **Overhead**: Minimal (no
planning documents required) **Risk Level**: Very Low
...
**What**: <Brief description> **Why**: <Reason for change> **Files**: <List of
1-2 files>
