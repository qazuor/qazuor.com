        ...
        <div ref={containerRef} className="relative w-full h-screen">
            ...
            {currentIndex > 0 && (
                <div className="fixed top-20 left-2 flex flex-col items-center z-20">
                    ...
                    >
                        <span className="text-2xl" style={{ color: 'hsl(var(--text-muted))' }}>
                            ←
                        </span>
                        <div className="text-lg font-mono font-semibold" style={{ color: 'hsl(var(--text-muted))' }}>
                            {displayedPrevYear}
                        </div>
                    </div>
                </div>
            ...
            <div className="fixed inset-0 flex items-center justify-center pointer-events-none z-10">
                ...
                >
                    <TimelineIcon
                        ...
                        className={`w-[25rem] h-[25rem] transform ${currentIndex % 2 ? 'rotate-6' : '-rotate-6'}`}
                    />
                </div>
            </div>
