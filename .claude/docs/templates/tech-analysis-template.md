...
**Date**: YYYY-MM-DD **Related PDR**: [PDR.md](./PDR.md) **Status**: Draft | In
Review | Approved | Implemented **Tech Lead**: {Name}

---

## 1. Executive Summary

**Feature Overview:** {1-2 paragraph summary of what we're building}

**Technical Approach:** {High-level summary of the technical solution}
