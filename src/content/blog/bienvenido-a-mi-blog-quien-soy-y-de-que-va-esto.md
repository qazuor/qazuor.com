...
- Posts escritos por IA sin revisión ni criterio.
- Tutoriales copiados de la documentación oficial.
...
corporativo ni los posts llenos de buzzwords.

Prefiero un post corto que diga algo útil a uno largo que no diga nada.
...
Si querés charlar sobre algún proyecto, tenés alguna pregunta técnica, o
simplemente querés decir hola, podés encontrarme en:

- **GitHub**: [@qazuor](https://github.com/qazuor)
- **LinkedIn**: [Leandro Asrilevich](https://linkedin.com/in/qazuor)
- **Email**: Desde la sección de contacto del sitio
