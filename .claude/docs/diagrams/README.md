...
This directory contains Mermaid diagrams visualizing the Hospeda workflow system
architecture.
...
- 6 teams:
  ...
  - Specialized Team (tech-writer, i18n-specialist, enrichment-agent,
    seo-ai-specialist)
- Reporting lines
- Color-coded by team
...
```markdown
See the [Workflow Decision Tree](../diagrams/workflow-decision-tree.mmd) for
workflow selection.
```
