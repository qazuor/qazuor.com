...
1. **ALWAYS Analyze First**: Before starting ANY step, identify which
   specialized agents are needed
2. **ALWAYS Use Task Tool**: Delegate ALL work to specialized agents using Task
   tool
3. **NEVER Create Documents**: The coordinating agent NEVER creates PDR.md,
   tech-analysis.md, or TODOs.md
4. **NEVER Assume Capability**: Never assume you can do the work because "you
   understand it"
...
**Phase 1** is the planning and design phase where we create a comprehensive,
atomic plan ready for implementation.

**Duration:** 2-6 hours (depending on feature complexity)

**Key Principle:** Plan thoroughly before coding. Good planning saves time in
implementation.

**Key Principle:** ALWAYS delegate to specialized agents. NEVER do the work
directly.
...
**Note:** This checkpoint is optional because user has already approved the
technical approach, which defines the task scope
