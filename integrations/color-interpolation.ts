...
function generateTransitionCSS(colors: SectionColors, steps: number): string {
  ...
  for (const transition of transitions) {
    ...
    interpolations.forEach((color, index) => {
      css += `    --${transition.name}-${index + 1}: ${color};\n`;
    });
    css += '\n';
  }
...
:root {
  ...
  --section-hero-bg: ${lightColors.hero};
  --section-about-bg: ${lightColors.about};
  --section-skills-bg: ${lightColors.skills};
  --section-projects-bg: ${lightColors.projects};
  --section-blog-bg: ${lightColors.blog};
  --section-testimonials-bg: ${lightColors.testimonials};
  --section-contact-bg: ${lightColors.contact};
  --section-footer-bg: ${lightColors.footer};
...
.dark {
  ...
  --section-hero-bg: ${darkColors.hero};
  --section-about-bg: ${darkColors.about};
  --section-skills-bg: ${darkColors.skills};
  --section-projects-bg: ${darkColors.projects};
  --section-blog-bg: ${darkColors.blog};
  --section-testimonials-bg: ${darkColors.testimonials};
  --section-contact-bg: ${darkColors.contact};
  --section-footer-bg: ${darkColors.footer};
