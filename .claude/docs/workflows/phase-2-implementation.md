...
This document describes the implementation phase workflow for the Hospeda
project.
...
**Phase 2** is the implementation phase where we build the feature following
...
**IMPORTANT**: Code MUST be committed before marking task complete. This ensures
cross-device sync works correctly.

**See**: [Task Completion Protocol](./task-completion-protocol.md) for full
details
...
When you complete ANY task during Phase 2, you MUST immediately update all state
tracking files:
...
- **ALWAYS** keep the three files in sync (TODOs.md, .checkpoint.json,
...
**See Also:** [Task Completion Protocol](./task-completion-protocol.md) for full
details
