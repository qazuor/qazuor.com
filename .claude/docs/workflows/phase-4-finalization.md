...
**Phase 4** is the finalization phase where we document the work and prepare
commits for the user to review and merge.
...
**⚠️ CRITICAL**: State files MUST be updated and committed before considering
the feature "complete". This ensures accurate project tracking and team
visibility.
